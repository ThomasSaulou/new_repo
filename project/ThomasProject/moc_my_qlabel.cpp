...
QT_MOC_LITERAL(5, 46, 14) // "Mouse_Released"

    },
    "my_qlabel\0Mouse_Pressed\0\0Mouse_Pos\0"
    "Mouse_Left\0Mouse_Released"
};
...
void my_qlabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (my_qlabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&my_qlabel::Mouse_Released)) {
                *result = 3;
                return;
            }
        }
