...
#include "../ImageViewer/QListWidget_Sample-master/CustomWidget.h"
...
QT_MOC_LITERAL(1, 13, 10), // "removeItem"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 42, 4), // "item"
QT_MOC_LITERAL(5, 47, 24) // "on_btnRemoveItem_clicked"

    },
    "CustomWidget\0removeItem\0\0QListWidgetItem*\0"
    "item\0on_btnRemoveItem_clicked"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->removeItem((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (CustomWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomWidget::removeItem)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomWidget::removeItem(QListWidgetItem * _t1)
{
