...
#include "../Color-harmonization-with-Qt/colorwheel.h"
...
QT_MOC_LITERAL(5, 39, 10), // "hueChanged"
QT_MOC_LITERAL(6, 50, 3), // "hue"
QT_MOC_LITERAL(7, 54, 9), // "svChanged"
QT_MOC_LITERAL(8, 64, 8) // "newcolor"

    },
    "ColorWheel\0colorChange\0\0color\0setColor\0"
    "hueChanged\0hue\0svChanged\0newcolor"
};
...
void ColorWheel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colorChange((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 1: _t->setColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 2: _t->hueChanged((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 3: _t->svChanged((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ColorWheel::*)(const QColor & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorWheel::colorChange)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ColorWheel::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ColorWheel.data,
    qt_meta_data_ColorWheel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ColorWheel::colorChange(const QColor & _t1)
{
