...
#include "../QtPainter_Qt5/resizedialog.h"
...
QT_MOC_LITERAL(1, 13, 9), // "setResize"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 21) // "on_buttonBox_accepted"

    },
    "ResizeDialog\0setResize\0\0on_buttonBox_accepted"
};
...
void ResizeDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ResizeDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setResize((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ResizeDialog::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ResizeDialog::setResize)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ResizeDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ResizeDialog.data,
    qt_meta_data_ResizeDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ResizeDialog::setResize(int _t1, int _t2)
{
